...
![Visão Executiva](dashboard/prints/visao_executiva.png)
...
![Análise de Risco](dashboard/prints/analise_de_risco.png)
...
![Crescimento](dashboard/prints/crescimento.png)
...
Abra o SQL Server Management Studio e execute `sql/SCRIPTS_CRIACAO_BD.sql` seguido de `sql/VW_CHURN_PAGAMENTOS.sql`.

**5. Execute os notebooks**

Abra os notebooks em `python/` na ordem e configure a string de conexão com seus dados do SQL Server.
